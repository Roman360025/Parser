...
log_f = log_f + "log_of_parser_csv" + "_" + str(now).replace(" ", "_") + ".log"
...
url_whole = {
    ...
    1345: [
        ...
        "https://market.yandex.ru/catalog--aksessuary-dlia-ukhoda-za-litsom/16734794/list?hid=16133574&local-offers-first=0&viewtype=list",
